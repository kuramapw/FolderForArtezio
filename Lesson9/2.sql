...
insert into persons(name, surname, rang, cash) values ('KakaShi','Hatake','Hokage',15000);

select * from persons where cash<30000;
select * from persons where rang='Hokage' and cash<30000;
